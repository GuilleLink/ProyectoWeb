...
const App = () => {
    ...
    return(
        <div>
            <Header />
            <FullCard type='top-full-card' tittle="Make someone's holiday." subtittle='' sub_subtittle='' redirectionLink=''/>
            ...
            <FullCard type='bottom-full-card' tittle='' subtittle='' sub_subtittle='' redirectionLink=''/>
        </div>
    )
};
